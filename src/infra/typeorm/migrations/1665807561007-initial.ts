...
export class initial1665807561007 implements MigrationInterface {
    name = 'initial1665807561007'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`address\` (\`id\` varchar(36) NOT NULL, \`street\` varchar(200) NOT NULL, \`number\` varchar(10) NOT NULL, \`zipcode\` varchar(10) NOT NULL, \`neighborhood\` varchar(64) NOT NULL, \`city\` varchar(64) NOT NULL, \`state\` varchar(64) NOT NULL, \`complement\` varchar(64) NOT NULL, \`userId\` varchar(36) NULL, UNIQUE INDEX \`REL_d25f1ea79e282cc8a42bd616aa\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
